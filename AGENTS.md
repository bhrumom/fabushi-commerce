# Fabushi Commerce — Agent Instructions

These instructions apply repository-wide to AI-assisted development in `bhrumom/fabushi-commerce`.

## CRITICAL: Repository ownership

This repository is the canonical source for **commerce platform, payment/product purchase flows, entitlements and commerce-specific release logic**.
